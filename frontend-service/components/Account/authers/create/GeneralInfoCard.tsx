      ...
      <div className="flex justify-between border-b py-10">
        ...
        <div className="w-7/12 space-y-2">
          ...
          <div className="space-y-1">
            ...
            <div className="w-full">
              <input type="date" className="outline-none border-zinc-400 border rounded-md px-4 py-2 w-full" value={Born} onChange={(e) => setBorn(e.target.value)} />
            </div>
          </div>
          <div className="space-y-1">
            <div className="text-gray-600">Death</div>
            <div className="w-full">
              <input type="date" className="outline-none border-zinc-400 border rounded-md px-4 py-2 w-full" value={Death} onChange={(e) => setDeath(e.target.value)} />
            </div>
          </div>
        </div>
      </div>
