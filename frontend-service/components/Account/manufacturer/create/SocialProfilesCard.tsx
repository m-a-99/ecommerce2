...
const SocialProfilesCard = ({ SocialMediaPlatforms, SocialProfiles, setSocialProfiles }: props) => {
  function add() {
            ...
            return (
              <div key={SocialProfile.Key} className="space-y-5">
                <div className="flex justify-between  items-center ">
                  ...
                  <div onClick={() => remove(SocialProfile.Key)} className="text-red-500 cursor-pointer  select-none">
                    Remove
                  </div>
                </div>
