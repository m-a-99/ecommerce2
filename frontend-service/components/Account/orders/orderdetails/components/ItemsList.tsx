    ...
    <div className=" h-min w-full rounded-md ">
      <div className="rounded-md overflow-clip border bg-gray-200/60">
        <Table
          ...
          List={order.OrderShops.map((shop) => {
            return {
              "Shops and  Items": (
                <div className="space-y-3 border-dashed border-2 p-5 rounded-lg border-indigo-400 ">
                          ...
                          List={[
                            {
                              ...
                              "Order Status": shop.ShopOrderStatus,
                  ...
                  <div className="font-semibold text-indigo-500 font-mono"> Shop Order Items</div>
