...
function ProductsHeadder() {
  ...
  return (
    <div className="py-8 px-10 bg-white h-min w-full shadow-md rounded-md flex items-center justify-between">
      ...
      {userInfo?.AccountType==="Seller"&&<div className="w-3/12 flex justify-end">
...
export default ProductsHeadder