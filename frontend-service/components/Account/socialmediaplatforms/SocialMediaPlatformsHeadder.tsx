...
function SocialMediaPlatformsHeadder() {
  return (
    <div className="py-8 px-10 bg-white h-min w-full shadow-md rounded-md flex items-center justify-between">
      <span className="text-zinc-700 font-semibold text-lg w-3/12">Social Media Platforms</span>
      ...
      <div className="w-3/12 flex justify-end">
        <Link href={"/account/socialmediaplatforms/create"}>
...
export default SocialMediaPlatformsHeadder