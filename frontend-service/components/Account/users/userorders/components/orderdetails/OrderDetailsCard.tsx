...
const OrderDetailsCard = ({ order_details_id, OrderStatus,Orders }: props) => {
 
  const [order, setorder] = useState<OrdersType>(Orders.Data[0]);
  useEffect(() => {
    if (order_details_id) {
      setorder(Orders.Data.find(v=>v._id===order_details_id) as any);
    }
  }, [order_details_id]);

  return (
    <div className="w-full overflow-auto customscrollbar min-h-[400px]   bg-white drop-shadow-lg">
      ...
      {Orders.Data.length > 0 ? (
        ...
        <div className="flex justify-center items-center h-full py-10">
          <div>
            <svg className="w-[300px] h-[240px]" xmlns="http://www.w3.org/2000/svg"  data-name="Layer 1" width="574.17079" height="411.08457" viewBox="0 0 574.17079 411.08457">
              <path d="M870.10983,364.92228H555.91623a16.69541,16.69541,0,0,0-16.68029,16.6803v50.91879a16.69541,16.69541,0,0,0,16.68029,16.68029h314.1936a16.69541,16.69541,0,0,0,16.68029-16.68029V381.60258A16.69541,16.69541,0,0,0,870.10983,364.92228Z" transform="translate(-312.9146 -244.45771)" fill="#f2f2f2" />
              <path d="M438.9146,655.54229h-125a1,1,0,1,1,0-2h125a1,1,0,0,1,0,2Z" transform="translate(-312.9146 -244.45771)" fill="#3f3d56" />
              <path d="M420.56111,342.43613a9.377,9.377,0,0,0-1.92211,14.24941l-9.08746,19.40559,10.44581,8.39865,12.44837-27.58469a9.42779,9.42779,0,0,0-11.88461-14.469Z" transform="translate(-312.9146 -244.45771)" fill="#ffb8b8" />
              <path
              ...
              <path d="M379.98689,640.13638h35.92975a0,0,0,0,1,0,0v13.88195a0,0,0,0,1,0,0H393.86882a13.88193,13.88193,0,0,1-13.88193-13.88193v0A0,0,0,0,1,379.98689,640.13638Z" transform="translate(483.0473 1049.66109) rotate(179.99483)" fill="#2f2e41" />
              <polygon points="34.386 398.946 45.818 398.945 51.255 354.849 34.382 354.851 34.386 398.946" fill="#ffb8b8" />
              <path d="M344.85119,640.13638h35.92975a0,0,0,0,1,0,0v13.88195a0,0,0,0,1,0,0H358.73312a13.88193,13.88193,0,0,1-13.88193-13.88193v0A0,0,0,0,1,344.85119,640.13638Z" transform="translate(412.77591 1049.66426) rotate(179.99483)" fill="#2f2e41" />
              <circle cx="67.86696" cy="66.30574" r="24.56103" fill="#ffb8b8" />
              <path d="M393.42211,376.476a37.85906,37.85906,0,0,0-18.27958-31.21223c-6.34533-3.73908-13.29081-5.19728-18.81648.32839a38.35409,38.35409,0,0,0-7.836,11.76114,50.5051,50.5051,0,0,0-.934,37.4904l13.15154,36.33391,30.43919,3.29758a4,4,0,0,0,4.42762-4.13644Z" transform="translate(-312.9146 -244.45771)" fill="#2f2e41" />
              <path
              ...
              />
              <path
                id="b77c6965-cdfc-4713-bd9a-03fafd9c7c98-156"
                data-name="Path 395"
              ...
              <path
                ...
                fill="#3f3d56"
              />
              <path d="M620.1504,315.62959a29.03223,29.03223,0,1,1,29.032-29.03223A29.06519,29.06519,0,0,1,620.1504,315.62959Z" transform="translate(-312.9146 -244.45771)" fill="#678ae4" />
              <path d="M827.53615,310.301H676.63385a7.02328,7.02328,0,1,1,0-14.04656h150.9023a7.02328,7.02328,0,0,1,0,14.04656Z" transform="translate(-312.9146 -244.45771)" fill="#ccc" />
              <path d="M726.57648,280.452H676.63385a7.02328,7.02328,0,1,1,0-14.04656h49.94263a7.02328,7.02328,0,0,1,0,14.04656Z" transform="translate(-312.9146 -244.45771)" fill="#ccc" />
              <path
                id="b837c4e1-e336-4370-ba9c-f06fbd333d33-157"
                data-name="Path 395"
                ...
                fill="#fff"
              />
              <path d="M735.4051,381.45771H421.21151a16.69543,16.69543,0,0,0-16.6803,16.6803V449.0568a16.69542,16.69542,0,0,0,16.6803,16.68029H735.4051a16.69542,16.69542,0,0,0,16.6803-16.68029V398.138A16.69543,16.69543,0,0,0,735.4051,381.45771Z" transform="translate(-312.9146 -244.45771)" fill="#fff" />
              <path
                ...
                fill="#3f3d56"
              />
              <path d="M485.1504,452.62959a29.03223,29.03223,0,1,1,29.032-29.03223A29.06519,29.06519,0,0,1,485.1504,452.62959Z" transform="translate(-312.9146 -244.45771)" fill="#678ae4" />
              <path d="M692.53615,447.301H541.63385a7.02328,7.02328,0,1,1,0-14.04656h150.9023a7.02328,7.02328,0,0,1,0,14.04656Z" transform="translate(-312.9146 -244.45771)" fill="#ccc" />
              <path d="M591.57648,417.452H541.63385a7.02328,7.02328,0,1,1,0-14.04656h49.94263a7.02328,7.02328,0,0,1,0,14.04656Z" transform="translate(-312.9146 -244.45771)" fill="#ccc" />
              <path
                id="ae103e1a-a1d0-4366-bdbf-adaac5567630-158"
                data-name="Path 395"
                ...
                fill="#fff"
              />
              <path d="M411.02308,392.94388a9.37692,9.37692,0,0,0-12.79623,6.55718l-21.12033,3.61811-.93165,13.371,29.75422-5.52838a9.42779,9.42779,0,0,0,5.094-18.01793Z" transform="translate(-312.9146 -244.45771)" fill="#ffb8b8" />
              <path
