    ...
    <div>
      {addAddress ? (
        <div className="bg-white p-10 space-y-5 drop-shadow-md  rounded-md">
          ...
          <div className="flex flex-wrap justify-between text-zinc-600 text-lg font-semibold">
        ...
        <div className="bg-white p-10 space-y-5 drop-shadow-md  rounded-md">
          ...
          <div className="flex flex-wrap justify-center md:justify-start lg:justify-start  gap-5">
            {userInfo.ShippingAddress && (
              <div className=" max-w-[250px] min-w-[200px] space-y-2 rounded-xl bg-gray-100  p-5 text-sm">
                <div className="flex justify-between ">
