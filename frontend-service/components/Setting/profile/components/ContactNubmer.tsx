          ...
          <div className="flex flex-wrap justify-center md:justify-start lg:justify-start gap-5">
            {userInfo?.Contacts &&
              userInfo?.Contacts.map((e) => (
                <div className=" max-w-[250px] space-y-2 rounded-xl bg-gray-100  p-5 text-sm" key={e._id}>
                  <div className="flex justify-between ">
                    ...
                    <div onClick={() => e._id && delete_contact(e._id)} className="text-red-500 cursor-pointer select-none">
