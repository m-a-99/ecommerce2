...
import CreateProductHeadderCard from "../../../components/Account/products/create/CreateProductHeadderCard";
import FeaturedImageCard from "../../../components/Account/products/create/FeaturedImageCard";
import GalleryCard from "../../../components/Account/products/create/GalleryCard";
import SellerShopsCard from "../../../components/Account/products/create/SellerShopsCard";
import GroupAndCategories from "../../../components/Account/products/create/GroupAndCategories";
import GeneralInfoCard from "../../../components/Account/products/create/GeneralInfoCard";
import ProductTypeCard from "../../../components/Account/products/create/ProductTypeCard";
import SimpleProductCard from "../../../components/Account/products/create/SimpleProductCard";
import ProductVariationInformation from "../../../components/Account/products/create/ProductVariationInformation";
